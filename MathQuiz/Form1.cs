...
namespace MathQuiz
{
    public partial class Form1 : Form{
        ...
        //Interger variables for addition problem
        int addend1;
        int addend2;

        //Interger variables for subtraction problem
        int minuend;
        int subtrahend;

        //Interger variables for multiplication problem
        int multiplicand;
        int multiplier;

        //Interger variables for division problem
        int dividend;
        int divisor;
        ...
        public void StartTheQuiz(){
            //Change background color back to nothing
        ...
        public Form1(){
            ...
            //Populate Date
            dateLabel.Text = DateTime.Now.ToString("dd MMMMMM yyyy");
        }
        ...
        private void answer_Enter(object sender, EventArgs e) {
            ...
            if (answerBox != null) {
                int lengthOfAnswer = answerBox.ToString().Length;
